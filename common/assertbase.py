...
class AssertBase:
    ...
    def assert_main(self,assert_str,res):
        ...
        try:
            ...
            raise
    def assert_status(self, assert_code,code):
        """
        请求响应状态码断言
        :data code:
        :data assert_code:
        ...
        try:
            ...
            self.logging.info("请求状态码对比成功,请求状态码为:{0},断言状态码为:{1}".format(code, assert_code))
    ...
    def assert_body(self, assert_body,body):
        ...
        try:
            ...
            self.logging.info("响应body对比成功，响应body为:{0},断言body为:{1}".format(body, assert_body))
    ...
    def assert_in_body(self,  assert_text,body):
        ...
        try:
            ...
            self.logging.info("断言字符串在响应体中，断言字符串为:{0},响应信息为:{1}".format(assert_text, body))
            return True
        except Exception:
    ...
    def assert_time(self,  assert_time,time):
        ...
        try:
            ...
            self.logging.info("响应时间，断言时间:{0},响应时间:{1}".format(assert_time, time))
            return True
        except Exception:
            self.logging.error("响应时间超时，断言时间:{0},响应时间:{1}".format(assert_time, time))
            raise
